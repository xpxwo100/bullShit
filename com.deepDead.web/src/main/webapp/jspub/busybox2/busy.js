...
function showBusy(message){
    HideElement();
    var eSrc=(document.all)?this:arguments[1];
   ...
   strHtml =" <div style=\"width:100%; text-align:center;padding-top:10px \">";
   strHtml+=" <img src=\"../../../jspub/busybox2/GreenBar.gif\" width='150px' height='20px'><br>";
   ...
   strHtml+=" </div>";
    ...
    strHtml+="<iframe frameborder=\"0\" src=\"\" style=\"position:absolute; visibility:inherit;top:0px; left:0px; width:250px; height:60px; z-index:-1; filter='progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)';\"></iframe>";//加个iframe防止被drowdownlist等控件挡住
...
function closeBusy(){
    var shield= by("shield");
    var alertFram= by("alertFram");
    if(shield!=null) {

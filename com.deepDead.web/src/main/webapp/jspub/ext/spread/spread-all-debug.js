...
Ext.define('Spread.grid.View', {
    ...
    getRowIndex: function(rowEl) {
    	//XXX:修改代码
		if(Ext.fly(rowEl).up('tbody')==null)
		{
			return -1;
		}
        // Table <table> element
    ...
    coverCell: function(position) {
        ...
        if (me.fireEvent('beforecovercell', me, position, coverEl) !== false) {
            ...
            //XXX:复选框不能取消选择
            if(position.column == 0 && position.cellEl.classList.contains("x-grid-cell-row-checker")){
                coverEl.setStyle('z-index', -1);
            }else{
...
//XXX:扩展函数
Ext.define('Spread.selection.RangeRowModel', {
    'extend':  Ext.selection.RowModel ,
    alias: 'selection.rangerow',
    isRangeModel: true,
    initialViewRefresh: true,
    dataChangedRecently: false,
    keyNav: null,
...
Ext.define('Spread.util.TSVTransformer', {
    ...
    transformToTSV: function(selectionPositions) {
        ...
        if(selectionPositions==null || selectionPositions=="undefined"){
            return tsvText;
        }

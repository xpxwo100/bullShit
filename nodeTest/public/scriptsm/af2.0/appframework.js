    ...
    var af = (function(window) {
        ...
        */
        ...
        function detectUA($, userAgent) {
            $.os = {};
						/*tag:201306261137
             	为了识别 中兴 android 4.03 浏览器的 webkit 修改如下 
             	by tangmingbao
             */
            //$.os.webkit = userAgent.match(/WebKit\/([\d.]+)/) ? true : false;
            $.os.webkit = userAgent.match(/WebKit/) ? true : false;
            //end modify
						/*tag:tag:20131025_1456 by nicklee
						为了识别 中兴 android 4.03 浏览器的 Android 修改如下 
						*/
						$.os.android = userAgent.match(/Android/) || userAgent.match(/Silk-Accelerated/) ? true : false;
